package dev accelerometer_NewAxis;
...
public class accelerometer_NewAxis extends Activity implements SensorEventListener {
    private SensorManager sensorManager;
    TextView xCoor; // deklarasikan X axis object
    TextView yCoor; // deklarasikan Y axis object
    TextView zCoor; // deklarasikan J axis object
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        zCoor=(TextView)findViewById(R.id.zcoor); // buat J axis object

        sensorManager=(SensorManager)getSystemService(SENSOR_SERVICE);
// menambahkan listener. Listener untuk class ini adalah accelerometer_NewAxis
...
<activity android:name=".accelerometer_NewAxis"
